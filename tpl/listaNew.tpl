  ...
  <html>
  <head>
    <link rel="shortcut icon" href="https://portal.igp.gob.pe/sites/all/themes/simplecorp/tema_igp/favicon.ico" type="image/x-icon">
    <meta charset="utf-8" />
...
<link rel='stylesheet' type='text/css' href='https://bndg.igp.gob.pe/plugin/leaflet/leaflet.css'>
<script type='text/javascript' src='https://bndg.igp.gob.pe/plugin/leaflet/leaflet.js?i=16012019'></script>
...
<body onload="xajax_auxIni('10','1'); xajax_tabla();">
...
<!--            <img class="img-responsive" src="http://ultimosismo.igp.gob.pe/images/igp.png" > -->
            <img class="img-responsive" style="max-width: 140px; max-height: 60px;" src="https://portal.igp.gob.pe/sites/default/files/logos/logo-igp-min.png" >
          </a>
        </div>
      </div>
    </div>
          ...
          <div class="ui bottom attached tab segment active" data-tab="first">
            ...
            <div class="three wide column">
              ...
              <div class="twelve wide column">
                <div id="map"> </div>
                <div style="position:absolute; left: 20px; top: 520px;z-index:999"><img src="img/magnitudes.png"></div>
                <div style="position:absolute; left: 20px; top: 380px;z-index:999"><img src="img/profundidades.png"></div>
              </div>
            </div>
...
<!--      <img src="img/footer/igp-logo.png" style="margin-right: 10px;"> -->
      <img src="https://portal.igp.gob.pe/sites/default/files/logos/logo-igp-min.png" style="height: 80px; margin-right: 10px;">
    </div>
<!--
    <div class="text-center">

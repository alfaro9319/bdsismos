...
<html lang="en">
  <head>
    ...
    <title>Simos Reportados - Per&uacute;</title>
	    	...
	    	<div id="header" class="cabecera1">
	    		...
	    		<div class="span-4 last"><img src="img/igp-trans.png"></div>
                            ...
                            <div class="span-24 last" style="background-image:url('img/004.gif'); background-repeat: repeat-x;" >
                                    ...
                                    <span style="float:left;" class="link-blanco">
                                    Sismos reportados</span>
    ...
    <li><a href="#tabs-2">Lista</a></li>
        ...
        <div id="tabs-2">
	      <table>
				...
				<img style="vertical-align:middle;" width="20px" src="img/pdf.png"/><a class="imprimir" target="_blank" href="#" onclick="formMonth.submit(); return false;"> Archivo con los sismos reportados de los meses seleccionados</a>
	      		</div>
    ...
    <div id="tabs-1">
	      <table>
	      		...
	      		<div id="herramientas" style="padding-left:20px; text-align:left;">
                            <span class="txt-azul">
                                    <a class="imprimir" target="_blank" href="tmp/sismos_sentidos.pdf"><img style="vertical-align:middle;" width="20px" src="img/pdf.png"/> Archivo de mapas con los sismos reportados por mes</a>
                            </span>
	      		</div>
                  ...
                  <br><h3>Sismos instrumentales: ML (≤6.5), Mw (>6.6.)</h3>
	      ...
	      <div class="span-24 contenedor-pie">
				...
				<a class="mostaza" href="#">Contacto</a>| Escríbenos a: <a class="mostaza" href="mailto:admin.otidg@igp.gob.pe">admin.otidg@igp.gob.pe</a>
				</p>

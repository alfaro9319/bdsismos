...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->Cell(0, 10, '             Reporte de los últimos sismos reportados', 0, false, 'C', 0, '', 0, false, 'M', 'T');
		*/
		$this->SetFont('dejavusans', 'B', 20);
...
$monthList="";
for($i=0; $i<13; $i++) {
	if(isset($_GET["optionMonth".$i])){
		$monthList.=$_GET["optionMonth".$i].",";
	}
}
$monthList=substr($monthList,0,-1);
$data=readListSismos("FilterMonth",0,0,$monthList);

//print_r($monthList,FALSE);
...
$pdf->Output('IGP_sismos_reportados_de_los_meses_seleccionados.pdf', 'D');

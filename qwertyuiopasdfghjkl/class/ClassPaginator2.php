...
*/
	...
	function paginate($ipp,$page,$function)
	{
...
*/
		if($this->num_pages > 10)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<li><a class=\"paginate\" href=# onclick=\"$function($this->items_per_page,$prev_page)\">&laquo; Anterior</a></li> ":"<li><span class=\"inactive\" href=\"#\">&laquo; Anterior</span></li> ";
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				if($i==1 Or $i==$this->num_pages Or in_array($i,$this->range))
				{
					$this->return .= ($i == $this->current_page And $page != 'All') ? "<li><span class=\"current\">$i</span></li> ":"<li><a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=# onclick=\"$function($this->items_per_page,$i)\">$i</a></li> ";
				}
				if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= " ... ";
			}
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($page != 'All')) ? "<li><a class=\"paginate\" href=# onclick=\"$function($this->items_per_page,$next_page)\">Siguiente &raquo;</a></li>\n":"<li><span class=\"inactive\" href=\"#\">&raquo; Siguiente</span></li>\n";
			//$this->return .= ($page == 'All') ? "<a class=\"current\" style=\"margin-left:10px\" href=\"#\">All</a> \n":"<a class=\"paginate\" style=\"margin-left:10px\" href=# onclick=\"$function('All',1)\">All</a> \n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
			{
				$this->return .= ($i == $this->current_page) ? "<li><span class=\"active\">$i</span></li>":"<li><a class=\"active\" href=# onclick=\"$function($this->items_per_page,$i)\">$i</a></li>";
			}
			//$this->return .= "<a class=\"paginate\" href=# onclick=\"$function('All',1) \">All</a> \n";
		}
		$this->low = ($this->current_page-1) * $this->items_per_page;
	...
	function paginateSearch($ipp,$page,$form,$function)
	{
		...
		if($this->num_pages > 10)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate\" href=# onclick=\"$function($this->items_per_page,$prev_page,$form)\">&laquo; Previous</a> ":"<span class=\"inactive\" href=\"#\">&laquo; Previous</span> ";
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				if($i==1 Or $i==$this->num_pages Or in_array($i,$this->range))
				{
					$this->return .= ($i == $this->current_page And $page != 'All') ? "<span class=\"current\">$i</span> ":"<a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=# onclick=\"$function($this->items_per_page,$i,$form)\">$i</a> ";
				}
				if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= " ... ";
			}
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($page != 'All')) ? "<a class=\"paginate\" href=# onclick=\"$function($this->items_per_page,$next_page,$form)\">Next &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Next</span>\n";
		...
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
			{
				$this->return .= ($i == $this->current_page) ? "<span class=\"current\">$i</span>":"<a class=\"paginate\" href=# onclick=\"$function($this->items_per_page,$i,$form)\">$i</a>";
			}

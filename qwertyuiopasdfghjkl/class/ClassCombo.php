...
class combo{
	...
	function comboList($__options,$__values,$__action="",$__script="",$__title="",$__valtitle="",$__id="",$__default="",$__class="combo"){
	...
	function simpleCombo($__options,$__values,$__action="",$__script="",$__id="",$__default=""){
	...
	function comboNoList($__action="",$__script="",$__title=""){

...
class Paginator{
	...
	function paginateAuthor($ipp,$page,$function,$divAutor)
	{
		...
		if($this->num_pages > 10){
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate-ant\" href=#search_author onclick=	\"$function($this->items_per_page,$prev_page,xajax.getFormValues('$divAutor'))\">&laquo; Anterior</a> ":"<span class=\"inactive\" href=\"#search_authorSEC\">&laquo; Anterior</span> ";
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($page != 'All')) ? "<a class=\"paginate-sig\" href=#search_author onclick=\"$function($this->items_per_page,$next_page,xajax.getFormValues('$divAutor'))\">Siguiente &raquo;</a>\n":"<span class=\"inactive\" href=\"#search_author\">&raquo; Siguiente</span>\n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
	...
	function paginate($ipp,$page,$function,$idarea)
	{
		...
		if($this->num_pages > 10)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate-ant\" href=# onclick=\"$function($this->items_per_page,$prev_page,'','',$idarea)\">&laquo; Anterior</a> ":"<span class=\"inactive\" href=\"#\">&laquo; Anterior</span> ";
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($page != 'All')) ? "<a class=\"paginate-sig\" href=# onclick=\"$function($this->items_per_page,$next_page,'','',$idarea)\">Siguiente &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Siguiente</span>\n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
	...
	function paginateSearch($ipp,$page,$form,$function,$idarea)
	{
		...
		if($this->num_pages > 10)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate-ant\" href=# onclick=\"$function($this->items_per_page,$prev_page,$form,'',$idarea)\">&laquo; Anterior</a> ":"<span class=\"inactive\" href=\"#\">&laquo; Anterior</span> ";
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($page != 'All')) ? "<a class=\"paginate-sig\" href=# onclick=\"$function($this->items_per_page,$next_page,$form,'',$idarea)\">Siguiente &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Siguiente</span>\n";
	...
	function paginateResoluciones($ipp,$page,$function,$idTipoDocumento,$year)
	{
		...
		if($this->num_pages > 10)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate-ant\" href=# onclick=\"$function($this->items_per_page,$prev_page,$idTipoDocumento,$year)\">&laquo; Anterior</a> ":"<span class=\"inactive\" href=\"#\">&laquo; Anterior</span> ";
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($page != 'All')) ? "<a class=\"paginate-sig\" href=# onclick=\"$function($this->items_per_page,$next_page,$idTipoDocumento,$year)\">Siguiente &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Siguiente</span>\n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)

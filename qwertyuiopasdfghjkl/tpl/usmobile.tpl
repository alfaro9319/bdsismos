...
<div class="content-moreinfo">
  ...
  <div id="dialog" title="Réplicas" style="display:none">{replicas}</div>
        ...
        <div class="eight wide floated column">
          ...
          <script src='https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCri9Mss1uNQJLhpbca4FH0UWSjy33pf9Q'></script>
            <div class="maps-content-goo">
              ...
              <script type='text/javascript'>function init_map(){var myOptions = {zoom:8,center:new google.maps.LatLng({latitud_sismo},{longitud_sismo}),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,animation: google.maps.Animation.DROP,icon: "http://ultimosismo.igp.gob.pe/files/ico-mapigp.png",position: new google.maps.LatLng({latitud_sismo},{longitud_sismo})});infowindow = new google.maps.InfoWindow({content:'<strong>{referencia_sismo}</strong>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
            </div>
          </div>
        ...
        <div class="aligned column">
           ...
           <div class="hvcenter">
            <div class="field-ayuda">
              <ul>
               <li><label>¡Cuidado con la información falsa en redes sociales! Los sismos no se pueden predecir. <a target="_blank" href="http://ultimosismo.igp.gob.pe/files/leermas.pdf"> (Leer más)</a></label></li>
               <li><label>¡Sismos con epicentros en el mar y magnitudes mayores a 7, pueden generar tsunamis!</label></li>
             </ul>
            </div>
           </div>
...
<div class="row">
  <div class="eight wide column">
    <div class="field">
     <a href="#" onclick="mostrar_glosario()">Glosario del reporte &uacute;ltimo sismo</a>
    </div>
  </div>
  <div class="eight wide column">
    <div class="field">
...
<script type="text/javascript">
  ...
  function init_mapdet(){var myOptionsdet = {zoom:8,center:new google.maps.LatLng({latitud_sismo},{longitud_sismo}),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmapdet_canvas'), myOptionsdet);marker = new google.maps.Marker({map: map,animation: google.maps.Animation.DROP,icon: "http://ultimosismo.igp.gob.pe/files/ico-mapigp.png",position: new google.maps.LatLng({latitud_sismo},{longitud_sismo})});infowindow = new google.maps.InfoWindow({content:'<strong>Último sismo - IGP</strong><br>{referencia_sismo}'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}
